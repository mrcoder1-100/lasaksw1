...
const ClosensePage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white pt-20">
            <SEO
                title="Closense E-Commerce Development Case Study"
                description="Transforming retail visions into user-centric online platforms. Explore our custom e-commerce development for Closense."
                canonical="/blogs/closense-ecommerce"
            />
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-20 items-start">
                        ...
                        <div className="lg:sticky lg:top-40 h-fit lg:col-span-2 py-4">
                            ...
                            >
                                E-COMMERCE <br />
                                <span className="text-blue-500 text-outline-blue font-black">RETAIL</span> <br />
                                VISION
                            </motion.h2>
                            <div className="backdrop-blur-xl bg-white/5 border border-white/10 p-8 rounded-[2.5rem] shadow-2xl">
                                <h3 className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-6">Key Features</h3>
                                ...
                                <div className="mt-10 p-1 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600">
                                    <div className="bg-[#0f172a] p-6 rounded-xl h-full text-center">
                                        <h3 className="font-bold text-white text-lg mb-2 uppercase tracking-tight">Grow Online</h3>
                                        <p className="text-slate-400 text-sm mb-4">"Transforming retail visions into fully functional online platforms."</p>
                        ...
                        <div className="lg:col-span-3 space-y-16">
                            ...
                            >
                                ...
                                <div className="absolute bottom-10 left-10 z-20">
                                    ...
                                    <h3 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter">Closense E-Commerce</h3>
                                </div>
                            </motion.div>

                            {/* Section Intro */}
                            <div className="pl-8 border-l-4 border-blue-500/50">
                                <h3 className="text-2xl md:text-4xl font-black text-white mb-6 uppercase tracking-tight leading-none">Transforming Retail</h3>
                                <p className="text-slate-300 leading-relaxed text-lg md:text-xl font-light">
                                    "Developing custom e-commerce websites that transform visions into user-centric online platforms."
                                </p>
                            </div>
                                ...
                                {[
                                    {
                                        title: "Client Vision",
                                        icon: <TrendingUp />,
                                        desc: "Intuitive navigation and seamless user experience to differentiate brands in competitive markets.",
                                        color: "text-blue-400",
                                    ...
                                    },
                                    {
                                        ...
                                        icon: <ShoppingBag />,
                                        desc: "Advanced search, product filters, and a streamlined shopping cart for higher conversion.",
                                    ...
                                    },
                                    {
                                        title: "Mobile Ready",
                                        icon: <Smartphone />,
                                        desc: "Rigorous testing to ensure consistent, responsive performance across all devices.",
                                        color: "text-sky-400",
                                    ...
                                    },
                                    {
                                        ...
                                        icon: <Users />,
                                        desc: "Open communication and expert execution to refine every digital touchpoint.",
                                        color: "text-cyan-400",
