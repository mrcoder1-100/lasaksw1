...
const FinanceAdvisoryPage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white pt-20">
            <SEO
                title="Finance & Business Advisory Digital Solutions"
                description="Delivering excellence in financial digital solutions. We create professional websites for business consultants and financial advisory services."
                canonical="/blogs/finance-advisory"
            />
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-20 items-start">
                        ...
                        <div className="lg:sticky lg:top-40 h-fit lg:col-span-2 py-4">
                            ...
                            >
                                STRATEGIC <br />
                                <span className="text-blue-500 text-outline-blue font-black">ADVISORY</span> <br />
                                SYSTEMS
                            </motion.h2>
                            <div className="backdrop-blur-xl bg-white/5 border border-white/10 p-8 rounded-[2.5rem] shadow-2xl">
                                ...
                                <div className="mt-10 p-1 rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-600">
                                    <div className="bg-[#0f172a] p-6 rounded-xl h-full text-center">
                                        ...
                                        <p className="text-slate-400 text-sm mb-4">"Professional digital designs for professional financial services and business consultants."</p>
                        ...
                        <div className="lg:col-span-3 space-y-16">
                            ...
                            >
                                ...
                                <div className="absolute bottom-10 left-10 z-20">
                                    <p className="text-sm font-mono text-blue-400 mb-2 uppercase tracking-[0.2em]">IT Projects</p>
                                    <h3 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter">Finance Advisory</h3>
                                </div>
                            </motion.div>

                            {/* Section Intro */}
                            <div className="pl-8 border-l-4 border-blue-500/50">
                                <h3 className="text-2xl md:text-4xl font-black text-white mb-6 uppercase tracking-tight leading-none">Trust-Based Design</h3>
                                <p className="text-slate-300 leading-relaxed text-lg md:text-xl font-light">
                                    "Adopting a collaborative approach to design and development, creating cohesive strategies aligned with financial visions."
                                </p>
                            </div>
                                ...
                                {[
                                    {
                                        title: "Sleek Layout",
                                        icon: <Layout />,
                                        desc: "Modern layout with a sophisticated color palette appealing to professionals seeking guidance.",
                                        color: "text-blue-400",
                                    ...
                                    },
                                    {
                                        title: "Intuitive UI",
                                        icon: <PieChart />,
                                        desc: "Clear categorization and dedicated insights sections for high-value financial content delivery.",
                                        color: "text-cyan-400",
                                    ...
                                    },
                                    {
                                        ...
                                        icon: <CheckCircle />,
                                        desc: "Integrated testimonials and case studies to showcase expertise and drive user engagement.",
                                        color: "text-sky-400",
                                    ...
                                    },
                                    {
                                        title: "Global Reach",
                                        icon: <Globe />,
                                        desc: "Polished digital presence allowing clients to expand advisory services to a wider world audience.",
