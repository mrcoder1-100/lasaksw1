...
const AppetitePage = () => {
    return (
        <div className="min-h-screen flex flex-col justify-between">
            <SEO
                title="Lasak Appetite - Coming Soon"
                description="Lasak Appetite is launching soon. Stay tuned for our amazing new digital product platform."
                canonical="/products/appetite"
            />
            {/* Hero Section */}
            <section className="relative flex-1 flex flex-col items-center justify-center text-center px-4 md:px-6 overflow-hidden min-h-[60vh] pt-32">
