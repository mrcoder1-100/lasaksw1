...
const DigitalMarketingPage = () => {
    ...
    return (
        <div className="min-h-screen pt-32 md:pt-20 bg-[#0a0f1c]">
            <SEO
                title="Digital Marketing - Brand Growth Strategies"
                description="Drive real business growth with our digital marketing expertise. SEO, Social Media, PPC, and content strategies tailored for your brand."
            ...
            <section className="relative py-16 md:py-24 overflow-hidden px-4 flex items-center justify-center">
                ...
                <div className="absolute inset-0 z-0">
                    {/* High-Impact Digital Marketing Image */}
                    <img
                ...
                <div className="container mx-auto relative z-10 flex flex-col items-center text-center">
                    ...
                    >
                        ...
                        <div className="w-44 h-44 md:w-64 md:h-64 mx-auto relative group">
                            ...
                            <TrendingUp className="w-full h-full text-blue-500 p-14 relative z-10 animate-float" strokeWidth={1} />
                        </div>
                    </motion.div>
                    ...
                    >
                        DIGITAL<br /><span className="text-blue-500">MARKETING</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: 30 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        "At Lasak Technologies, we dissect your brand to build strategies that deliver measurable results and drive real business growth."
                    </motion.p>
                </div>
            </section>
                    ...
                    <div className="lg:col-span-4 flex flex-col">
                        <div className="lg:sticky lg:top-40 h-fit">
                            <h2 className="text-4xl md:text-7xl font-black text-white mb-8 leading-[1.1] uppercase tracking-tighter">
                                Growth<br />
                                <span className="text-blue-500 text-outline-blue">Marketing</span><br />
                                Experts
                            </h2>
                            <div className="rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl relative group aspect-video bg-blue-950/20">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center p-8">
                                    <div className="p-6 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 text-center">
                                        <p className="text-white text-lg font-bold uppercase tracking-widest">Connect. Engage. Convert.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative rounded-[3rem] overflow-hidden bg-[#0f172a] p-10 md:p-24 text-center border border-white/10 shadow-3xl">
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center h-full">
                            ...
                            <p className="text-blue-100 max-w-4xl mx-auto mb-12 text-lg md:text-xl leading-relaxed opacity-80">
                                "Let's strategize and execute a digital marketing plan that puts your brand in front of the right people."
                            </p>
                            <Link to="/contact">
