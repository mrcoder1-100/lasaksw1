                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-8 space-y-16">
                            ...
                            >
                                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-white border-l-4 border-indigo-500 pl-4">Meeting Client-Specific Goals</h2>
                                <p className="text-slate-300 leading-relaxed text-lg mb-6">
                                    At LASAK Technologies, we share our successful execution of an eccentric gear mechanism design that meets our client’s precise requirements. This project, both complex and innovative, led by Mr. Ellavarasan and Mr. Karthikeyan, ensures compliance with Indian vehicle standards.
                                </p>
                            </motion.div>
                                    ...
                                    {[
                                        {
                                            ...
                                            icon: <Target />,
                                            desc: "Our primary focus was developing a solution that surpassed performance expectations, ensuring successful implementation across various industrial applications.",
                                        ...
                                        },
                                        {
                                            ...
                                            icon: <PenTool />,
                                            desc: "The eccentric gear mechanism is known for its complexity. We applied advanced engineering techniques to create a system that optimized performance.",
                                        ...
                                        },
                                        {
                                            ...
                                            icon: <ShieldCheck />,
                                            desc: "Compliance with Indian vehicle standards was essential, emphasizing both safety and reliability in our mechanical systems.",
                                            color: "text-blue-400",
                                        ...
                                        },
                                        {
                                            title: "Expert Team",
                                            icon: <Users />,
                                            desc: "We acknowledge the tireless efforts of Mr. Ellavarasan and Mr. Karthikeyan, whose commitment to innovation drove this project's success.",
                            ...
                            >
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h2 className="text-2xl md:text-3xl font-bold text-white">Industrial Innovation</h2>
                                </div>
                                <p className="text-slate-300 mb-6 font-light italic border-l-2 border-violet-500 pl-4">
                                    "Pushing the boundaries of mechanical design and innovation."
                                </p>
                                <p className="text-slate-300 leading-relaxed">
                                    This project is a prime example of how LASAK Technologies continues to lead in mechanical engineering. By delivering mechanisms that meet stringent specifications, we contribute to the advancement of industrial engineering.
                                </p>
                            </motion.div>
                        ...
                        <div className="lg:col-span-4 hidden lg:block">
                            <div className="sticky top-24 space-y-8">
                                ...
                                <div className="p-6 rounded-xl bg-gradient-to-br from-indigo-600 to-violet-600 text-white shadow-lg">
                                    <h3 className="font-bold text-xl mb-2">Complex Projects?</h3>
                                    <p className="indigo-100 text-sm mb-4">We handle intricate mechanical designs.</p>
