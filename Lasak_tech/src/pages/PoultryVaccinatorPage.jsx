                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-8 space-y-16">
                            ...
                            >
                                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-white border-l-4 border-blue-500 pl-4">Innovation in Poultry Vaccination Technology</h2>
                                <p className="text-slate-300 leading-relaxed text-lg mb-6">
                                    Our automated poultry vaccinator introduces precision-engineered systems that simplify the vaccination process, ensuring uniformity and safety for poultry farms.
                                </p>
                            </motion.div>
                            ...
                            <div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {[
                                        {
                                            title: "Retrofitting Ready",
                                            icon: <Factory />,
                                            desc: "The design can be retrofitted into existing poultry setups, reducing the need for expensive new infrastructure while improving efficiency.",
                                            color: "text-blue-400",
                                        ...
                                        },
                                        {
                                            ...
                                            icon: <Activity />,
                                            desc: "Equipped with advanced control systems, the vaccinator ensures accurate dosage delivery, protecting chick health and reducing human error.",
                                        ...
                                        },
                                        {
                                            ...
                                            icon: <TrendingDown />,
                                            desc: "Automation reduces manual labor, speeds up the vaccination process, and provides consistent, repeatable performance across thousands of chicks.",
                                        ...
                                        },
                                        {
                                            ...
                                            icon: <DollarSign />,
                                            desc: "The retrofitted vaccinator enhances productivity while being cost-efficient and sustainable, supporting modern poultry farming practices.",
                            ...
                            <motion.div
                                ...
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                className="bg-gradient-to-r from-blue-900/20 to-yellow-900/20 p-8 rounded-2xl border border-white/10"
                            >
                                <div className="flex items-center gap-4 mb-6">
                                    <Cpu className="w-10 h-10 text-blue-400" />
                                    <h2 className="text-2xl md:text-3xl font-bold text-white">Future-Ready Equipment</h2>
                                </div>
                                <p className="text-slate-300 mb-6 font-light italic border-l-2 border-yellow-500 pl-4">
                                    "Designed with adaptability in mind, paving the way for smart farming solutions."
                                </p>
                                <p className="text-slate-300 leading-relaxed">
                                    This innovation helps farmers scale operations with reliability and precision, ensuring that their equipment is ready for the future of agricultural automation.
                                </p>
                            </motion.div>
                        ...
                        <div className="lg:col-span-4 hidden lg:block">
                            <div className="sticky top-24 space-y-8">
                                ...
                                <div className="p-6 rounded-xl bg-gradient-to-br from-blue-600 to-yellow-600 text-white shadow-lg">
                                    <h3 className="font-bold text-xl mb-2">Modernize Your Farm</h3>
                                    <p className="blue-100 text-sm mb-4">Learn more about our automated poultry solutions.</p>
