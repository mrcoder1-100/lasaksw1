...
import { Construction, Zap, Settings, ShieldCheck, RefreshCw, Activity } from 'lucide-react';
                ...
                <div className="container mx-auto relative z-10 flex flex-col items-center text-center">
                    ...
                    >
                        ...
                        <div className="w-32 h-32 md:w-48 md:h-48 mx-auto bg-gradient-to-br from-blue-400 to-blue-800 rounded-full shadow-[0_0_50px_rgba(59,130,246,0.5)] mb-8 flex items-center justify-center relative overflow-hidden">
                            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1581094288338-2314dddb7ece?q=80&w=500')] opacity-50 bg-cover mix-blend-overlay"></div>
                        </div>
                    </motion.div>
                    ...
                    >
                        Modernize your assets. We upgrade existing equipment and structures to improve efficiency, safety, and performance without full replacement.
                    </motion.p>
                </div>
            </section>
                    ...
                    <div className="lg:col-span-4 flex flex-col">
                        <div className="sticky top-24">
                            <h2 className="text-4xl md:text-6xl font-black text-white mb-8 leading-[1.1]">
                                We Offer<br />
                                <span className="text-blue-500">Retro Fitting</span><br />
                                Like
                            </h2>
                            <div className="rounded-2xl overflow-hidden border border-white/10 shadow-2xl relative group">
                                ...
                                <img src="https://images.unsplash.com/photo-1535974606771-3375cb474c15?q=80&w=600&auto=format&fit=crop" alt="Retro Fitting Engine" className="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-700" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative rounded-[2.5rem] overflow-hidden bg-blue-600 p-10 md:p-24 text-center">
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center h-full">
                            <h2 className="text-4xl md:text-6xl font-black text-white mb-6 max-w-5xl mx-auto leading-tight">
                                Let’s Upgrade Your Systems with Expert Retrofitting
                            </h2>
                            <p className="text-blue-50 max-w-4xl mx-auto mb-10 text-lg md:text-xl font-light leading-relaxed">
                                Retrofitting is more than just modernizing equipment — it’s about enhancing efficiency, performance, and reliability. At LASAK Technologies, we assess your existing systems and implement upgrades that extend their life, reduce downtime, and optimize operations.
                                <br /><br />
                                Ready to bring your machinery up to modern standards and boost productivity?
                            </p>
